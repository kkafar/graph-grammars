...
class TestProduction5(unittest.TestCase):
    def is_any_mapping_feasible(self, graph: Graph):
        p5 = P5()
        mapping_gen = graph.generate_subgraphs_isomorphic_with(p5.get_lhs())
        return any(p5.is_mapping_feasible(graph, mapping) for mapping in mapping_gen)
    ...
    def test_production_can_be_applied_if_hanging_nodes_in_different_places(self):
        ...
        node_5 = Node(NodeAttrs('v', 0, 0.5, True))
        node_6 = Node(NodeAttrs('v', 0.5, 0, True))
        nodes = [node_0, node_6, node_1, node_2, node_4, node_3, node_5]
    ...
    def test_production_can_be_applied_on_more_complex_graph(self):
        ...
        nodes = [node_0, node_6, node_8, node_1, node_2, node_7, node_4, node_3, node_5]
        ...
        graph.add_edge(Edge(node_7.handle, node_8.handle, EdgeAttrs(kind='e', flag=False)))
        for node_1, node_2 in it.pairwise(nodes + [node_0]):
            graph.add_edge(Edge(node_1.handle, node_2.handle, EdgeAttrs(kind='e', flag=False)))
    ...
    def test_production_cannot_be_applied_if_one_hanging_node_is_missing(self):
        ...
        node_4 = Node(NodeAttrs('v', 1, 0.5, True))
        node_6 = Node(NodeAttrs('v', 0.5, 0, True))
        nodes = [node_0, node_6, node_1, node_4, node_2, node_3]
    ...
    def test_production_cannot_be_applied_if_one_hanging_node_is_in_wrong_place(self):
        ...
        node_3 = Node(NodeAttrs('v', 0, 1, False))
        node_4 = Node(NodeAttrs('v', 1, 0.5, True))
        node_5 = Node(NodeAttrs('v', 0, 0.5, False))
        node_6 = Node(NodeAttrs('v', 0.5, 0, True))
        nodes = [node_0, node_6, node_1, node_4, node_2, node_3, node_5]
